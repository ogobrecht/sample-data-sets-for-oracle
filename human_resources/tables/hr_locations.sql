...
create table hr_locations (
  location_id    number(4) generated by default on null as identity (start with 3300 increment by 100 maxvalue 9900 nocache nocycle) primary key,
  street_address varchar2(40),
  postal_code    varchar2(12),
  city           varchar2(30) not null,
  state_province varchar2(25),
  country_id     char(2) references hr_countries
);
