...
create table hr_employees (
  employee_id    number(6) generated by default on null as identity (start with 207 increment by 1 nocache nocycle) primary key,
  ...
  manager_id     number(6)     references employees,
  department_id  number(4)     references departments,
  --
  check ( salary > 0 ),
);

-- we need this here because the tables do cross reference each other
alter table hr_departments modify manager_id references employees;
