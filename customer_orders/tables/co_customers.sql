...
comment on table co_customers
  is 'Details of the people placing orders';

comment on column co_customers.customer_id 
  is 'Auto-incrementing primary key';

comment on column co_customers.email_address 
  is 'The email address the person uses to access the account';

comment on column co_customers.full_name
