...
Usage
-----
- `@disable_triggers.sql '{ table_prefix: "",     dry_run: false }'` (all tables, do the intended work)
- `@disable_triggers.sql '{ table_prefix: "",     dry_run: true  }'` (all tables, report only)
- `@disable_triggers.sql '{ table_prefix: "OEHR", dry_run: false }'` (only for tables prefixed with "OEHR")
- `@disable_triggers.sql '{ table_prefix: "CO",   dry_run: true  }'` (only for tables prefixed with "CO", report only)
